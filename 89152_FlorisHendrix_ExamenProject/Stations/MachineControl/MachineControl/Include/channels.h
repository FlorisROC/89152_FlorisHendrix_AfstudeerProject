...
TYPE
  ...
  CltCh_IO_State : STRUCT
    ...
    pCmd : ^SVRCHCMD;
  END_STRUCT;
  SvrCh_t_e_OPMode : STRUCT
    pMeth : ^CHMETH;
    dData : t_e_OPMode;
    pDsc : ^SVRDSC;
  END_STRUCT;
  CltCh_t_e_OPMode : STRUCT
    pCh : ^SvrCh_t_e_OPMode;
    dData : t_e_OPMode;
    pCmd : ^SVRCHCMD;
  END_STRUCT;
  ...
  CltChCmd__DriveAxisSet : STRUCT
    ...
    pCmd : ^_DriveAxisSet;
  END_STRUCT;
  CltChCmd__DriveErrorHandling : STRUCT
    pCh : ^SvrChCmd_iprStates;
    dData : iprStates;
    pCmd : ^_DriveErrorHandling;
  END_STRUCT;
  ...
  CltChCmd__OSKernel : STRUCT
    ...
    pCmd : ^_OSKernel;
  END_STRUCT;
  CltChCmd__QuitErrorLMCaxis : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^_QuitErrorLMCaxis;
  END_STRUCT;
  ...
  END_STRUCT;
  CltChCmd_AlarmOPMode3Para : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^AlarmOPMode3Para;
  END_STRUCT;
