...
#pragma pack(pop)
  ...
  [
    ...
    7 SDD_VCC18_ERROR,
    8 SDD_VCCE_ERROR,
    9 SDD_ASMFU_IMAX_ERROR,
    10 SDD_SINCOS_MINMAX_ERROR,
    11 SDD_SINCOS_MOVE_ERROR,
    12 SDD_REGEN_ERROR,
    13 SDD_ENCODER_COUNTER_ERROR,
    14 SDD_FEEDBACK_ADC,
    15 SDD_LVDS_ERROR,
    16 SDD_SAFETY_ERROR,
    17 SDD_SAFETY_WARNING,
    22 SDD_Z_IMPULS_ERROR,
    24 SDD_FEEDBACK_SUPPLY,
  ];
  _SDDISTATE : BDINT
  [
    1 SDD_OnePhase,
