...
//version 1.0
        ...
        calib_devicesetcalibrationex2   : pvoid;
    END_STRUCT;
END_TYPE
...
FUNCTION GLOBAL __cdecl P_TOUCHINFO_DEVICESETCALIBRATIONEX2
VAR_INPUT
    deviceid : udint;
    orderid : dint;
    pDimension : ^XYKOORDS;
...
#define OS_TOUCHINFO_DEVICESETCALIBRATIONEX2(p1, p2, p3, p4, p5, p6) pCalib^.calib_devicesetcalibrationex $ P_TOUCHINFO_DEVICESETCALIBRATIONEX2(p1, p2, p3, p4, p5, p6)
